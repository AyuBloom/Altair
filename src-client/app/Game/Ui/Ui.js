...
class Ui extends EventEmitter {
    constructor() {
        ...
        this.addComponent("DayNightTicker", new _UiDayNightTicker(this), UiAnchor.BOTTOM_LEFT);
        this.addComponent("Toolbar", new _UiToolbar(this), UiAnchor.BOTTOM_CENTER);
        this.addComponent("HealthBar", new _UiHealthBar(this), UiAnchor.BOTTOM_RIGHT);
        this.addComponent("ShieldBar", new _UiShieldBar(this), UiAnchor.BOTTOM_RIGHT);
        this.addComponent("Resources", new _UiResources(this), UiAnchor.BOTTOM_RIGHT);
        this.addComponent("PartyIcons", new _UiPartyIcons(this), UiAnchor.BOTTOM_RIGHT);
        this.addComponent("Chat", new _UiChat(this), UiAnchor.TOP_LEFT);
        this.addComponent("Leaderboard", new _UiLeaderboard(this), UiAnchor.TOP_RIGHT);
        this.addComponent("SpellIcons", new _UiSpellIcons(this), UiAnchor.CENTER_LEFT);
        this.addComponent("MenuIcons", new _UiMenuIcons(this), UiAnchor.CENTER_RIGHT);
