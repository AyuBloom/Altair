  ...
  constructor(ui) {
    ...
    function addIconElem(i) {
      ...
      new _UiTooltip(This.iconElems[i], function (elem) {
        ...
        return (
          '<div class="hud-tooltip-party">\n                    <h4>' +
          playerName +
          "</h4>\n                    <h5>" +
          (playerData.isLeader === 1 ? "Leader" : "Member") +
          "</h5>\n                </div>"
        );
      });
    }
  ...
  update() {
    for (var i in this.iconElems) {
      ...
      if (playerData) {
        ...
        iconElem.innerHTML =
          "<span>" + playerData.displayName.substr(0, 2) + "</span>";
