...
function instantiateAsync(binary, binaryFile, imports, callback) {
    if (binary || typeof WebAssembly.instantiateStreaming != "function" || binaryFile.startsWith(dataURIPrefix) || typeof fetch != "function") {
...
if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) {
    ...
    scriptDirectory = scriptDirectory.indexOf("blob:") !== 0 ? scriptDirectory.substr(0, scriptDirectory.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "";
    doXHR = function (url) {
    ...
    while (idx < endPtr) {
        ...
        if (u0 & 128) {
            ...
            if ((u0 & 224) != 192) {
                ...
                u0 = (u0 & 240) == 224 ? (u0 & 15) << 12 | u1 << 6 | u2 : (u0 & 7) << 18 | u1 << 12 | u2 << 6 | u8Array[idx++] & 63;
                if (u0 < 65536) {
...
var getEntryFunction = Module._main = function () {
    return (getEntryFunction = Module._main = Module.asm.i).apply(null, arguments);
};
var _MakeBlendField = Module._MakeBlendField = function () {
    return (_MakeBlendField = Module._MakeBlendField = Module.asm.j).apply(null, arguments);
};
function __errno_location() {
    return (__errno_location = Module.asm.__errno_location).apply(null, arguments);
}
function _malloc() {
